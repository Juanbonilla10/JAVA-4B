...
public class TipoServicioController implements Serializable {
    ...
    @EJB
    private controller.TipoServicioFacade ejbFacade;
    ...
    public TipoServicio getTipoServicio(java.lang.String id) {
    ...
    public static class TipoServicioControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof TipoServicio) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + TipoServicio.class.getName());
            }
        }
